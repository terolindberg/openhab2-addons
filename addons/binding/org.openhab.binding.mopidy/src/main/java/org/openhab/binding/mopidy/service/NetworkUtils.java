 ...
 */
package org.openhab.binding.mopidy.service;
...
public class NetworkUtils {
    ...
    public static TreeSet<String> getInterfaceIPs() {
        ...
        try {
            ...
            for (Enumeration<NetworkInterface> en = NetworkInterface.getNetworkInterfaces(); en.hasMoreElements();) {
                ...
                // logger.debug("Checking network interface " + networkInterface.getDisplayName());
    ...
    public static boolean nativePing(String hostname, int port, int timeout)
        ...
        if (SystemUtils.IS_OS_UNIX) {
            ...
            throw new Exception("System Ping not supported");
        }
